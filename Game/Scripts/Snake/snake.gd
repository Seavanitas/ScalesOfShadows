...
@onready var snake_attack_hitbox_collider: CollisionShape3D = $Snake_Attack_Hitbox/Snake_Attack_Hitbox_Collider

func _ready() -> void:
	snake_attack_hitbox_collider.disabled = true
...
func _sprite_flip() -> void:
	if current_dir == 1:
		...
		snake_attack_hitbox_collider.position.x = 2.37
	elif current_dir == -1: 
